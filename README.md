...
(„ułóż jadłospis…"). W nagłówku panelu są oba tryby z nazwami modeli, aktywny
podświetlony: przed pierwszą wiadomością przełączasz je dowolnie, w trakcie rozmowy
zmiana trybu zaczyna nową rozmowę (tryb należy do rozmowy), a ↻ zaczyna od nowa w tym
samym trybie. Modele zmienisz w `konfiguracja/web.json`: `claudeModel`
